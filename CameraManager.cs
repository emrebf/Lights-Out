...
public class CameraManager : MonoBehaviour
{
    ...
    public Transform cameraTransform; //tranforms the actual camera object in the scene
    public LayerMask collisionLayers;  //the layers we want the camera to collide with
    private float defaultPosition;
    private Vector3 cameraFollowVelocity = Vector3.zero;
    private Vector3 cameraVectorPosition;

    public float cameraCollisionOffset = 0.2f; //how much the camera will jump off of objects it collides with
